...
function FeaturedInfo() {
  return (
    <div className="space-y-4 border-bottom">
      <div className="flex space-x-4 items-start">
        ...
        <div className="w-11/12">
          <h2 className="text-lg font-bold">Tự Check in</h2>
          <p className="text-gray-400 text-base">
            Tự check in bằng khóa thông minh
          </p>
        </div>
      </div>
      <div className="flex space-x-4 items-start">
        ...
        <div className="w-11/12">
          <h2 className="text-lg font-bold">Sungwon là chủ nhà siêu cấp</h2>
          <p className="text-gray-400 text-base">
            Chủ nhà siêu cấp là những chủ nhà có kinh nghiệm, được đánh giá cao
            và là những người cam kết mang lại quãng thời gian ở tuyệt vời cho
            khách.
          </p>
        </div>
      </div>
      <div className="flex space-x-4 items-start">
        ...
        <div className="w-11/12">
          <h2 className="text-lg font-bold">
            Miễn phí hủy trong vòng 48 tiếng
          </h2>
        </div>
      </div>
    </div>
