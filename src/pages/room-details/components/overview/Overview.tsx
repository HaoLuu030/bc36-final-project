  ...
  return (
    <div className="md:flex items-center space-x-2">
      <div className="border-bottom">
        ...
        <ul className="list-none flex justify-between text-base text-gray-600 sm:justify-start sm:space-x-2 md:text-sm">
          <li>{props.room?.khach} khách</li>
          <li>{props.room?.phongNgu} phòng ngủ</li>
          <li>{props.room?.giuong} giường</li>
          <li>{props.room?.phongTam} phòng tắm</li>
        </ul>
      </div>
      {/* show avatar when screen is medium big */}
      <div className="md:w-12 md:h-12 rounded-full relative hidden md:block flex-shrink-0">
        <img
